...
public class CellStyleAnnotation {
    ...
    public void applyStyle(
        org.apache.poi.ss.usermodel.CellStyle cellStyle, Font font, Workbook workbook) {
    ...
    public CellStyleAnnotation copy() {
        CellStyleAnnotation annotation = new CellStyleAnnotation();
        annotation.font = this.font.copy();
        annotation.dataFormat = this.dataFormat;
        annotation.hidden = this.hidden;
        annotation.locked = this.locked;
        annotation.quotePrefixed = this.quotePrefixed;
        annotation.alignment = this.alignment;
        annotation.wrapText = this.wrapText;
        annotation.verticalAlignment = this.verticalAlignment;
        annotation.rotation = this.rotation;
        annotation.indention = this.indention;
        annotation.borderLeft = this.borderLeft;
        annotation.borderRight = this.borderRight;
        annotation.borderTop = this.borderTop;
        annotation.borderBottom = this.borderBottom;
        annotation.leftBorderColor = this.leftBorderColor;
        annotation.rightBorderColor = this.rightBorderColor;
        annotation.topBorderColor = this.topBorderColor;
        annotation.bottomBorderColor = this.bottomBorderColor;
        annotation.fillPattern = this.fillPattern;
        annotation.fillBackgroundColor = this.fillBackgroundColor;
        annotation.fillForegroundColor = this.fillForegroundColor;
        annotation.shrinkToFit = this.shrinkToFit;
        return annotation;
    }
}
